...
export default component$((props: { is_admin: boolean }) => {
  return (
    <nav class="bg-transparent">
      <div class="w-full flex flex-wrap items-center justify-between gap-y-4">
        ...
        <div>
          <ul
            class="flex md:p-0 font-light border-gray-100 rounded-lg space-x-8 md:mt-0 border-0 dark:border-gray-700">
            {props.is_admin && (<li>
